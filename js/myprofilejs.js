...
{
getHTTPObject();
var a=this.form.course.value
var b=this.form.university.value
var c=this.form.passing.value
var d=this.form.percentage.value
...
var url="myprofile1.php";
var parameter="?nnn=" + a + "&course=" + a + "&university=" + b + "&passing=" + c + "&percentage=" + d;
//var cd=bc+ab;
/////////////////kill ie cache/////////////////////////
