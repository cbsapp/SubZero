...
<script type="text/javascript" src="js/coursesjs.js"></script>
...
<table width="982" height="142" border="0" align="center" cellpadding="1" cellspacing="1">
  ...
  <tr>
    ...
    <td width="751" colspan="2" valign="top"><table width="752" border="0" cellspacing="1" cellpadding="1">
      <tr>
        <th height="24" colspan="4" align="left" background="images/bar3.gif" class="style1" scope="col">Course Creation </th>
      </tr>
      <tr>
        <th colspan="4" align="left" bgcolor="#FFFFFF" scope="row"><div align="center" class="style2" id="msg" >
          <label>          </label>
          <table width="745" border="0" cellspacing="1" cellpadding="1">
            <tr>
              <th width="269" background="images/bar3.gif" bgcolor="#C5E7F5" class="style1" scope="col">Course Name </th>
              <th width="137" background="images/bar3.gif" bgcolor="#C5E7F5" class="style1" scope="col">No of Subject </th>
              <th width="127" height="22" background="images/bar3.gif" bgcolor="#C5E7F5" class="style1" scope="col">Total Duration </th>
              <th width="106" background="images/bar3.gif" bgcolor="#C5E7F5" class="style1" scope="col">View Details </th>
              <th width="90" background="images/bar3.gif" bgcolor="#C5E7F5" class="style1" scope="col">Delete</th>
            </tr>
			<?php
			include 'db.php';
//			mysql_connect("$serverip",$username,$password);
//@mysql_select_db($database) or die( "Unable to select database");
$query = " SELECT * FROM n_courses ORDER BY id DESC";
...
$nosubject=mysql_result($result,$i,"nosubject");
...
$num2=mysql_numrows($result2);
			?>
            <tr>
              <th align="left" bgcolor="#C5E7F5" scope="col"><span class="style4"><?php echo $coursename; ?></span></th>
              <th bgcolor="#C5E7F5" scope="col"><span class="style4"><?php echo $num2; ?></span></th>
              <th height="22" bgcolor="#C5E7F5" scope="col"><span class="style4"><?php echo $duration; ?></span></th>
              <th bgcolor="#C5E7F5" scope="col">Details</th>
              <th bgcolor="#C5E7F5" scope="col">Delete</th>
            </tr>
			<?php
			$i=$i+$num2;
			}
			?>
            <tr>
              <th bgcolor="#C5E7F5" scope="col">&nbsp;</th>
              <th bgcolor="#C5E7F5" scope="col">&nbsp;</th>
              <th height="22" bgcolor="#C5E7F5" scope="col">&nbsp;</th>
              <th bgcolor="#C5E7F5" scope="col">&nbsp;</th>
              <th bgcolor="#C5E7F5" scope="col">&nbsp;</th>
            </tr>
          </table>
      ...
      <tr>
        <th width="158" height="24" align="left" background="images/bar3.gif" bgcolor="#C5E7F5" class="style1" scope="row">Course Name </th>
        <th width="193" height="24" align="left" background="images/bar3.gif" bgcolor="#C5E7F5" class="style1" scope="row"><input name="coursename" type="text" class="style22" id="coursename" tabindex="1" size="25" /></th>
        <th width="154" height="24" align="left" background="images/bar3.gif" bgcolor="#C5E7F5" class="style1" scope="row">No of Subject </th>
        <th width="234" height="24" align="left" background="images/bar3.gif" bgcolor="#C5E7F5" class="style1" scope="row"><input name="nosubject" type="text" class="style22" id="nosubject" tabindex="1" size="10" onkeyup="submitt()" /></th>
      </tr>
      <tr>
        <th height="24" colspan="4" align="left" bgcolor="#FFFFFF" class="style2" scope="row"><div class="style2" id="crr" align="center"></div></th>
        </tr>
	  <tr>
