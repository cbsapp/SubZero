...
<head>
<script type="text/javascript" src="js/myprofilejs.js"></script>
...
<table width="982" height="142" border="0" align="center" cellpadding="1" cellspacing="1">
  ...
  <tr>
    ...
    <td width="751" colspan="2" valign="top"><table width="752" border="0" cellspacing="1" cellpadding="1">
      <tr>
        <th height="24" colspan="4" align="left" background="images/bar3.gif" class="style1" scope="col">My Profile </th>
      </tr>
      <tr>
        <th colspan="4" bgcolor="#FFFFFF" scope="row"><div align="center" class="style2" id="crr" >
          <label>          </label>
		  <?php
		  include 'config.php';
		  include 'db.php';
...
$percentage=mysql_result($result,$i,"percentage");
  ...
  ?>
      ...
      <tr>
        <th height="24" colspan="4" align="left" background="images/bar3.gif" bgcolor="#C5E7F5" class="style1" scope="row">Stage 2 of 4 </th>
        </tr>
      <tr>
        <th width="158" align="center" bgcolor="#C5E7F5" class="style2" scope="row">Course</th>
        <th width="193" height="24" align="center" bgcolor="#C5E7F5" class="style2" scope="row">University / Institute Name </th>
        <th width="154" align="center" bgcolor="#C5E7F5" class="style2" scope="row">Year of Passing </th>
        <th width="234" align="center" bgcolor="#C5E7F5" class="style2" scope="row">Percentage</th>
      </tr>
      <tr>
        <th align="center" bgcolor="#C5E7F5" class="style2" scope="row"><span class="style1">
          <input name="course" type="text" class="style22" id="course" tabindex="1" size="20" />
        </span></th>
        <th height="24" align="center" bgcolor="#C5E7F5" scope="row"><span class="style1">
          <input name="university" type="text" class="style22" id="university" tabindex="1" size="35" />
        </span></th>
        <th height="24" align="center" bgcolor="#C5E7F5" class="style2" scope="row"><span class="style1">
          <input name="passing" type="text" class="style22" id="passing" tabindex="1" size="20" />
        </span></th>
        <th height="24" align="center" bgcolor="#C5E7F5" scope="row"><span class="style1">
          <input name="percentage" type="text" class="style22" id="percentage" tabindex="1" size="20" />
        </span></th>
      </tr>
	  <tr>
