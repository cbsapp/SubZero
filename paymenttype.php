...
?>
<form name="form" method="post" action="paymenttype2.php">
<script>
function submitt()
{
...
<table width="982" height="142" border="0" align="center" cellpadding="1" cellspacing="1">
  ...
  <tr>
    ...
    <td width="751" colspan="2" valign="top"><table width="752" border="0" cellspacing="1" cellpadding="1">
      ...
      <tr>
        <th height="24" align="left" bgcolor="#C5E7F5" class="style2" scope="row">Total Amount </th>
        <th height="24" align="left" bgcolor="#C5E7F5" class="style1" scope="row"><input name="totalamount" type="text" class="style2" id="totalamount" tabindex="1" size="25" /></th>
      </tr>
      <tr>
        <th width="150" height="24" align="left" bgcolor="#C5E7F5" class="style1" scope="row"><span class="style2">Initial Amount  </span></th>
        <th width="595" height="24" align="left" bgcolor="#C5E7F5" class="style1" scope="row"><input name="intialamount" type="text" class="style2" id="intialamount" tabindex="1" size="15" /></th>
      </tr>
      <tr>
        <th height="24" align="left" bgcolor="#C5E7F5" class="style1" scope="row"><span class="style2">No of Installments </span></th>
        <th height="24" align="left" bgcolor="#C5E7F5" class="style1" scope="row"><input name="noinstallment" type="text" class="style2" id="noinstallment" tabindex="1" size="10" /></th>
      </tr>
      <tr>
        <th height="24" align="left" bgcolor="#C5E7F5" class="style1" scope="row"><span class="style2">Installment Amount </span></th>
        <th height="24" align="left" bgcolor="#C5E7F5" class="style1" scope="row"><input name="installmentamt" type="text" class="style2" id="installmentamt" tabindex="1" size="20" /></th>
      </tr>
      <tr>
