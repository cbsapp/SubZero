...
?>
<form name="form" method="post" action="bookrequest2.php">
<script>
function submitt()
{
...
<table width="982" height="142" border="0" align="center" cellpadding="1" cellspacing="1">
  ...
  <tr>
    ...
    <td width="751" colspan="2" valign="top"><table width="752" border="0" cellspacing="1" cellpadding="1">
      <tr>
        <th height="24" colspan="2" align="left" background="images/bar3.gif" class="style1" scope="col">Book Request</th>
      </tr>
      <tr>
      ...
      <tr>
        <th height="24" align="left" bgcolor="#C5E7F5" class="style2" scope="row">Batch Name </th>
        <th height="24" align="left" bgcolor="#C5E7F5" class="style1" scope="row"><input name="batchname" type="text" class="style2" id="batchname" tabindex="1" size="20" /></th>
      </tr>
      <tr>
        <th height="24" align="left" bgcolor="#C5E7F5" class="style2" scope="row">Book Name </th>
        <th height="24" align="left" bgcolor="#C5E7F5" class="style1" scope="row"><input name="bookname" type="text" class="style2" id="bookname" tabindex="1" size="20" /></th>
      </tr>
      <tr>
        <th width="150" height="24" align="left" bgcolor="#C5E7F5" class="style1" scope="row"><span class="style2">Delivery Date </span></th>
         <th height="24" align="left" bgcolor="#C5E7F5" scope="row" class="style2"><label class="style22"><script>DateInput('deliverydate', true, 'YYYY-MM-DD')</script>
