...
?>
<form name="form" method="post" action="comp2.php">
<script>
function submitt()
{
...
$query="SELECT * FROM n_complaints WHERE status='$st3' AND username='$uname'";
        ...
        <th height="24" colspan="6" align="left" bgcolor="#FFFFFF" class="style1" scope="row"><div align="center" class="style2" id="crr" >
          ...
          <table width="750" border="0" cellpadding="1" cellspacing="1">
            <tr>
              ...
              <td width="150" align="center" background="images/bar3.gif" class="style1">Sre Name</td>
...
$status=mysql_result($result,$i,"status");
	 ?>
            <tr>
              <td bgcolor="#C5E7F5" class="style2"><a href="javascript: comp('<?php echo $caseid; ?>');"><?php echo $caseid; ?></a></td>
              <td bgcolor="#C5E7F5" class="style2"><a href="javascript: comp('<?php echo $caseid; ?>');"><?php echo $srename; ?></a></td>
              <td bgcolor="#C5E7F5" class="style2"><a href="javascript: comp('<?php echo $caseid; ?>');"><?php echo $faculty; ?></a></td>
              <td height="23" bgcolor="#C5E7F5"><a href="javascript: comp('<?php echo $caseid; ?>');" class="style2"><?php echo $batch; ?></a></td>
              <td align="center" bgcolor="#C5E7F5" class="style2"><a href="javascript: comp('<?php echo $caseid; ?>');"><?php echo $datee; ?></a></td>
              <td align="center" bgcolor="#C5E7F5" class="style2"><a href="javascript: comp('<?php echo $caseid; ?>');"><?php echo $status; ?></a></td>
            </tr>
			<?php
	  $i++;
}
