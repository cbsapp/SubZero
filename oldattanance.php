      ...
      <tr>
        <th colspan="4" align="left" scope="row"><div align="center" class="style2" id="msg" >
          ...
          <table width="744" border="0" cellspacing="1" cellpadding="1">
            <tr>
              <th width="227" height="23" align="center" bgcolor="#C5E7F5" scope="col">Batch Name </th>
              <th width="194" align="center" bgcolor="#C5E7F5" scope="col">Batch Time </th>
              <th width="220" align="center" bgcolor="#C5E7F5" scope="col">Current Subject </th>
              <th width="90" align="center" bgcolor="#C5E7F5" scope="col"><label>Click Here </label></th>
            </tr>
			<?php
			include 'db.php';
...
$stos="Active";
$query = " SELECT * FROM n_batch WHERE status='$stos' AND faculty='$uname' ORDER BY id DESC";
...
while($i<$num)
{
$batchname=mysql_result($result,$i,"batchname");
$batchtime=mysql_result($result,$i,"time");
$currentsubject=mysql_result($result,$i,"currentsubject");
$query2 = " SELECT * FROM n_attanance WHERE batchname='$batchname' AND date='$datee' ORDER BY id DESC";
...
{
$ou="attanance1.php?batchname=";
$outt="$ou$batchname";
}
?>
            <tr>
              <th height="23" align="left" bgcolor="#C5E7F5" scope="col"><?php echo $batchname; ?></th>
              <th align="left" bgcolor="#C5E7F5" scope="col"><?php echo $batchtime; ?></th>
              <th align="left" bgcolor="#C5E7F5" scope="col"><?php echo $currentsubject; ?></th>
              <th align="center" bgcolor="#C5E7F5" scope="col"><a href="<?php echo $outt; ?>">Click Here</a> </th>
            </tr>
			<?php
			$i++;
			}
      ...
      <tr>
        ...
        <th colspan="3" align="right" bgcolor="#C5E7F5" scope="row"><a href="javascript: submitt();"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
      </tr>
    </table></td>
  </tr>
