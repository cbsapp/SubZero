...
<head>
<script type="text/javascript" src="js/myskillsjs.js"></script>
...
<table width="982" height="142" border="0" align="center" cellpadding="1" cellspacing="1">
  ...
  <tr>
    ...
    <td width="751" colspan="2" valign="top"><table width="752" border="0" cellspacing="1" cellpadding="1">
      ...
      <tr>
        <th colspan="2" bgcolor="#FFFFFF" scope="row"><div align="center" class="style2" id="crr" >
          <label>          </label>
		  <?php
		  include 'config.php';
		  include 'db.php';
...
$id=mysql_result($result,$i,"id");
  ...
  ?>
      ...
      <tr>
        <th height="24" colspan="2" align="left" background="images/bar3.gif" bgcolor="#C5E7F5" class="style1" scope="row">Stage 3 of 4 </th>
        </tr>
      <tr>
        <th width="528" align="left" bgcolor="#C5E7F5" class="style2" scope="row">Skills</th>
        <th width="217" height="24" align="center" bgcolor="#C5E7F5" class="style2" scope="row">Skill Level</th>
        </tr>
      <tr>
        <th align="left" bgcolor="#C5E7F5" class="style2" scope="row"><span class="style1">
          <input name="skills" type="text" class="style22" id="skills" tabindex="1" size="50" />
        </span></th>
        <th height="24" align="center" bgcolor="#C5E7F5" scope="row"><label class="style2">
          <select name="skilllevel" class="style2" id="skilllevel" tabindex="1">
