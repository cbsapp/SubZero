...
<table width="982" height="142" border="0" align="center" cellpadding="1" cellspacing="1">
  ...
  <tr>
    ...
    <td width="751" colspan="2" valign="top"><table width="752" border="0" cellspacing="1" cellpadding="1">
      ...
      <tr>
        <th width="150" height="24" align="left" bgcolor="#C5E7F5" class="style2" scope="row">Issue </th>
        <th width="595" height="24" align="left" bgcolor="#C5E7F5" class="style1" scope="row"><textarea name="issue" cols="50" rows="4" class="style2" id="issue" tabindex="1"></textarea></th>
      </tr>
