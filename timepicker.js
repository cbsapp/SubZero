...
//      url : www.sparrowscripts.com
	...
	function refreshTimePicker(mode) {
		...
		for (i=0;i<=11;i++) {
			...
			for (j=0;j<4;j++) {
				var tott=hr*60+j*15;
				sHTML+="<td width=57 style='cursor:hand' onmouseover='this.style.backgroundColor=\"#66CCFF\"' onmouseout='this.style.backgroundColor=\"\"' onclick='setTimePicker(\""+ tott + "," + suffix+"" + "\")'><a style='text-decoration:none;color:#000000' href='javascript:setTimePicker(\""+ tott + "," + suffix+"" + "\")'>" + hr + ":"+padZero(j*15) + "<font color=\"#808080\">" + suffix + "</font></a></td>";
			}
