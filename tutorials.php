      ...
      <tr>
        <th colspan="4" align="left" scope="row"><div align="center" class="style2" id="msg" >
          ...
          <table width="744" border="0" cellspacing="1" cellpadding="1">
            <tr>
              <th height="23" colspan="5" align="center" bgcolor="#C5E7F5" scope="col">Note : High Rating Will Get Awarded Every Month </th>
              </tr>
            <tr>
              <th width="146" height="23" align="center" bgcolor="#C5E7F5" scope="col">Tutorial Created By </th>
              <th width="172" align="center" bgcolor="#C5E7F5" scope="col">Title </th>
              <th width="193" align="center" bgcolor="#C5E7F5" scope="col">Views</th>
              <th width="89" align="center" bgcolor="#C5E7F5" scope="col">Rate It </th>
              <th width="128" align="center" bgcolor="#C5E7F5" scope="col"><label>View Tutorial </label></th>
            </tr>
            <tr>
              <th height="23" align="left" bgcolor="#C5E7F5" scope="col"><?php echo $sname; ?></th>
              <th align="left" bgcolor="#C5E7F5" scope="col"><?php echo $sname; ?></th>
              <th align="left" bgcolor="#C5E7F5" scope="col"><?php echo $sname; ?></th>
              <th align="left" bgcolor="#C5E7F5" scope="col">1 &nbsp;2 &nbsp;3&nbsp; 4 &nbsp;5 </th>
              <th align="center" bgcolor="#C5E7F5" scope="col"><a href="Viewtutorial.php?<?php echo $idd; ?>">
                <label></label>
              Click Here </a></th>
            </tr>
          </table>
